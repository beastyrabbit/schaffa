...
export function renderLanding(): string {
  return layout(
    ...
    `<header class="landing-nav">
      ...
      <nav aria-label="Primary navigation"><a href="/metadata/openapi.json">API</a><a class="nav-action" href="/account">Sign in or create account</a></nav>
    </header>
    <main class="landing">
      <section class="landing-hero">
        <p class="kicker">Self-hosted publishing for agents</p>
        <h1>Turn finished work into a link.</h1>
        <p class="hero-copy">Schaffa publishes standalone HTML pages and files without turning them into somebody else’s cloud. Anonymous pages last one hour. An account makes pages permanent and gives your agents revocable upload tokens.</p>
        <div class="landing-actions"><a class="primary-link" href="/account">Sign in or create account</a><a class="text-link" href="#quickstart">Publish anonymously</a></div>
      </section>
      <section class="landing-principles" aria-label="How Schaffa works">
        <article><span>01</span><h2>Bring the whole page</h2><p>Upload one complete HTML file. Schaffa stores the bytes and serves them under a strict, script-free content policy.</p></article>
        <article><span>02</span><h2>Keep control</h2><p>Files and permanent pages belong to your token. Tokens can be revoked, content can be taken down, and the service stays on your infrastructure.</p></article>
        <article><span>03</span><h2>Share the result</h2><p>Every publication gets a simple public URL. Images are cleaned and re-encoded; every upload is scanned before it is published.</p></article>
      </section>
      <section class="quickstart" id="quickstart">
        <div><p class="kicker">One command</p><h2>Publish an HTML page now.</h2><p>No account is required for an anonymous page. It disappears from public view after one hour.</p></div>
        <pre><code>npx schaffa upload ./mypage.html</code></pre>
      </section>
    </main>
    <footer class="landing-footer"><span>Schaffa means getting work done.</span><span>Inspired by <a href="https://postplan.dev">PostPlan</a> and <a href="https://uploadthing.com">UploadThing</a>. Built to be self-hosted.</span></footer>`,
  );
}
...
.landing-nav{max-width:1240px;height:76px;margin:0 auto;padding:0 32px;display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--line)}.landing-nav nav{display:flex;align-items:center;gap:24px;font-size:14px;font-weight:700}.landing-nav nav a{text-decoration:none}.landing-nav .nav-action{border:1px solid var(--ink);padding:9px 13px;border-radius:7px}.landing{max-width:1240px;margin:0 auto;padding:0 32px}.landing-hero{min-height:510px;padding:96px 0 80px;display:grid;grid-template-columns:minmax(0,860px);align-content:center;border-bottom:1px solid var(--line)}.kicker{margin:0 0 18px;color:var(--accent);font:700 12px/1.2 ui-monospace,SFMono-Regular,Menlo,monospace;letter-spacing:.08em;text-transform:uppercase}.landing-hero h1{max-width:840px;margin:0;font:700 clamp(54px,8vw,104px)/.9 Georgia,"Times New Roman",serif;letter-spacing:-.065em}.hero-copy{max-width:680px;margin:34px 0 0;color:var(--muted);font-size:19px;line-height:1.6}.landing-actions{display:flex;align-items:center;gap:24px;margin-top:34px}.landing-actions .primary-link{display:inline-block;padding:12px 17px}.text-link{font-weight:700}.landing-principles{display:grid;grid-template-columns:repeat(3,1fr);padding:0;border-bottom:1px solid var(--line)}.landing-principles article{padding:42px 38px 48px 0}.landing-principles article+article{border-left:1px solid var(--line);padding-left:38px}.landing-principles span{color:var(--accent);font:700 12px ui-monospace,SFMono-Regular,Menlo,monospace}.landing-principles h2,.quickstart h2{font:700 26px/1.1 Georgia,"Times New Roman",serif;letter-spacing:-.025em}.landing-principles p,.quickstart p{color:var(--muted);line-height:1.6}.quickstart{display:grid;grid-template-columns:minmax(250px,.8fr) minmax(420px,1.2fr);gap:70px;align-items:center;padding:72px 0}.quickstart .kicker{margin-bottom:12px}.quickstart h2{font-size:38px;margin:0}.quickstart pre{margin:0;overflow-x:auto;padding:24px;border:1px solid #292a26;background:#292a26;color:#f6f2e9;border-radius:9px;box-shadow:7px 7px 0 #c9c2b3}.quickstart code{font-size:13px;line-height:1.8}.landing-footer{max-width:1240px;margin:0 auto;padding:24px 32px 40px;border-top:1px solid var(--line);display:flex;justify-content:space-between;gap:24px;color:var(--muted);font-size:13px}@media(max-width:760px){.landing-nav{height:66px;padding:0 18px}.landing-nav nav>a:first-child{display:none}.landing{padding:0 18px}.landing-hero{min-height:auto;padding:72px 0 60px}.landing-hero h1{font-size:56px}.hero-copy{font-size:17px}.landing-actions{align-items:flex-start;flex-direction:column;gap:16px}.landing-principles{grid-template-columns:1fr}.landing-principles article{padding:32px 0}.landing-principles article+article{border-left:0;border-top:1px solid var(--line);padding-left:0}.quickstart{grid-template-columns:1fr;gap:28px;padding:56px 0}.quickstart pre{margin-right:7px}.landing-footer{padding:22px 18px 32px;flex-direction:column}}
`;
